...
class BlogPost(db.Model):
    ...
    # "posts" refers to the posts property in the User class.
...
class User(db.Model, UserMixin):
    ...
    # The "author" refers to the author property in the BlogPost
...
def register():
    if request.method == "POST":
        ...
        if user:
            flash("Looks like you are already registered. Log in Instead.")
